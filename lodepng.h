...
typedef struct LodePNGInfo {
  ...
  */
  ...
  unsigned chrm_defined = 1; /* Whether a cHRM chunk is present (0 = not present, 1 = present). */
  unsigned chrm_white_x = 31270u; /* White Point x times 100000 */
  unsigned chrm_white_y = 32900u; /* White Point y times 100000 */
  unsigned chrm_red_x = 64000u;   /* Red x times 100000 */
  unsigned chrm_red_y = 33000u;   /* Red y times 100000 */
  unsigned chrm_green_x = 30000u; /* Green x times 100000 */
  unsigned chrm_green_y = 60000u; /* Green y times 100000 */
  unsigned chrm_blue_x = 15000u;  /* Blue x times 100000 */
  unsigned chrm_blue_y = 6000u;  /* Blue y times 100000 */
